...
<script>
    ...
    export default {
        ...
        computed: {
            userAvator() {
                let default_img = this.$store.state.user.sex === 'woman' ? '/logo_icon.png' : '/logo_icon.png';
        ...
        methods: {
            ...
            save() {
                this.$refs.form.validate((valid) => {
                    if (valid) {
                        this.formData.oldPassword = MD5(this.formData.oldPassword + Config.passwordKey);
                        this.formData.newPassword = MD5(this.formData.newPassword + Config.passwordKey);
                        this.$http({
                            method: 'post',
