            ...
            <Form ref="form"
                ...
                <Row>
                    <FormItem label="模板下载:" prop="name">
                        <Button type="primary"
                                to="/template/充电桩数据导入模板.xlsx"
                                download="充电桩数据导入模板.xlsx"
                                target="_blank"
                                icon="ios-cloud-download">充电桩数据导入模板.xlsx</Button>
                    </FormItem>
...
<script>
    ...
    export default {
        ...
        computed: {
            uploadFileAction() {
                return Config.ajaxUrl + '/bike/exportBike'
            },
            uploadImagesAction() {
                return Config.ajaxUrl + '/file/upload/chargePile'
            }
        },
        data () {
            return {
