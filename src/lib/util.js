...
export const TOKEN_KEY = 'ikey_aks_admin';
...
export const setTagNavListInLocalstorage = list => {
    localStorage.tagNaveList_aks_admin = JSON.stringify(list);
};
/**
...
export const getTagNavListFromLocalstorage = () => {
    const list = localStorage.tagNaveList_aks_admin;
...
export const setMenuListInLocalstorage = list => {
    if (list == null) {
        localStorage.menuList_aks_admin = null;
    }
    else {
        localStorage.menuList_aks_admin = JSON.stringify(list);
    }
};
// 获取本地存储菜单权限数据
export const getMenuListInLocalstorage = () => {
    const list = localStorage.menuList_aks_admin;
